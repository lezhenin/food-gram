...
async def help_command(message):
    help_message = "Добавьте меня в беседу. Потом:\n" \
                   ...
                   "/add <блюдо> - добавить пункт заказа\n" \
                    "/delete <блюдо> - удалить пункт заказа\n" \
                   ...
                   "/notify - уведомить о доставке заказа\n" \
                   "/bill - загрузить фото чека с qr кодом\n" \
                   "\nПосле того, как заказ доставлен и чек загружен" \
                   " выполнятся автоматическое распределение позиций чека.\n" \
                   "При неверном распознавании:\n" \
                   "/take <блюдо> - опознать позицию чека как свой заказ\n" \
                   "/drop <блюдо> - убрать из своего заказа неверно распознанную позицию\n" \
